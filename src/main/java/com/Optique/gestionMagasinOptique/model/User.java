...
/** @pdRoleInfo migr=no name=UserJournals assc=associationUserUserJournals coll=java.util.Collection impl=java.util.HashSet mult=0..* */
...
//   public void setUserJournals(java.util.Collection<UserJournals> newUserJournals) {
